...
public class RouterTest {
    ...
    public void testGetRoute() {
        ...
        assertEquals("/rylan/index.html", router.parseRoute(mockRequest2));
    }
    ...
    public void testGettingTheCorrectResponseType() {
        assertEquals("java.io.ByteArrayInputStream", router.routeRequest(mockRequest).getClass().getName());
        assertEquals("java.io.FileInputStream", router.routeRequest(mockRequest2).getClass().getName());
        assertEquals("java.io.FileInputStream", router.routeRequest(mockRequest3).getClass().getName());
    }
}
