...
public class HomestakeTest {
    ...
    public void testSendResponse() throws IOException {
        InputStream mockResponse = new Router().routeRequest(clientRequest.readLine());
        homestake.sendResponse(new MockSocket("Test"), mockResponse);
    }
